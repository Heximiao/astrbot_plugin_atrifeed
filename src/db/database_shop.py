...
class AtriShopDB(AtriDB):
    ...
    def _seed_initial_items(self):
        ...
        initial_items = [
            ("蛋包饭", "🍳", "food", 45, 25, "热腾腾的蛋包饭，可以增加体力值"),
            ("机票", "✈️", "tool", 430, 0, "或许可以去更远的地方进行圣地巡礼？（开启剧情的关键道具）"),
            ("新鞋子", "👟", "apparel", 150, 25, "换上新鞋子，增加好感度"),
            ("新衣服", "👗", "apparel", 200, 30, "给亚托莉买的新衣服,增加好感度"),
            ("菠萝", "🍍", "food", 30, 20, "新鲜的菠萝，可以增加体力值。"),
            ("烟花", "🎆", "tool", 200, 25, "在夜晚绽放的美丽，能大幅提升好感。"),
            ("奶茶", "🧋", "food", 25, 10, "现代人的续命水，增加体力值")
        ]
